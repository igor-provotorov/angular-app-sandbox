...
***************************************************************************** */
  ...
  \*****************************************/
            ...
            /***/ function(module, __webpack_exports__, __webpack_require__) {
                ...
                const BASE_SEARCH_URL = "https://api.themoviedb.org/3/";
                const BASE_SEARCH_IMAGES_URL = "https://image.tmdb.org/t/p/w";
                const BASE_YOUTUBE_VIDEOS_URL = "https://www.youtube.com/watch?v=";
                const POSTER_IMAGE_SIZE_PX = 500;
                const POSTER = "poster";
                const ACTOR_IMAGE_SIZE_PX = 92;
                const ACTOR = "actor";
                const DEFAULT_IMAGE_SIZE_PX = 500;
                const API_KEY = "026c9d92e76619507fb31d8065f3304d";
                const OVER_THE_ALLOWED_LIMIT = 429;
                const SERVER_DELAY_TIME = 10000;
                const DIGITS = {
                    ZERO: 0,
                    ONE: 1,
                };
                const NO_ACTOR_IMAGE_URL =
  ...
  !*** ./src/app/core/mappers/index.ts ***!
  \***************************************/
            /*! exports provided: transformResultMovies */
            /***/ function(module, __webpack_exports__, __webpack_require__) {
                "use strict";
                __webpack_require__.r(__webpack_exports__);
                /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
                ...
                let SearchFilmsService = class SearchFilmsService {
                    ...
                    getFilmsFromApi(searchQuery) {
                        ...
                        return this.behaviorSubject$.pipe(
                            Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["debounce"])(() =>
                            ...
                            Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])(searchFilms =>
                                this.getDetailsFilmsInfo(searchFilms).pipe(
                                    Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(moviesArr =>
                                        this.checkNoMovies(moviesArr)
                                    ),
                                    Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["retryWhen"])(errorObservable =>
                     ...
                     */
                    getDetailsFilmsInfo(movies) {
                        if (movies.length) {
                            return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["forkJoin"])(
                                movies.map(movie =>
                                    this.http.get(
                                        Object(_utils_index__WEBPACK_IMPORTED_MODULE_5__["getMovieDetailsUrl"])(
                                            movie.id
                                        )
                                    )
                                )
  ...
  !*** ./src/app/core/utils/check-empty-results.util.ts ***!
  \********************************************************/
            /*! exports provided: checkEmptyResults */
            /***/ function(module, __webpack_exports__, __webpack_require__) {
                "use strict";
                __webpack_require__.r(__webpack_exports__);
                /* harmony export (binding) */ __webpack_require__.d(
  ...
  !*** ./src/app/core/utils/get-movie-details-url.util.ts ***!
  \**********************************************************/
            /*! exports provided: getMovieDetailsUrl */
            /***/ function(module, __webpack_exports__, __webpack_require__) {
                "use strict";
                __webpack_require__.r(__webpack_exports__);
                /* harmony export (binding) */ __webpack_require__.d(
  ...
  !*** ./src/app/core/utils/get-movie-trailer-url.util.ts ***!
  \**********************************************************/
            /*! exports provided: getMovieTrailerUrl */
            /***/ function(module, __webpack_exports__, __webpack_require__) {
                "use strict";
                __webpack_require__.r(__webpack_exports__);
                /* harmony export (binding) */ __webpack_require__.d(
  ...
  !*** ./src/app/movie-search-page/movie-search-page.component.ts ***!
  \******************************************************************/
            /*! exports provided: MovieSearchPageComponent */
            /***/ function(module, __webpack_exports__, __webpack_require__) {
                "use strict";
                __webpack_require__.r(__webpack_exports__);
                /* harmony export (binding) */ __webpack_require__.d(
  ...
  \***************************************************************/
            ...
            /***/ function(module, __webpack_exports__, __webpack_require__) {
                ...
                let MovieSearchPageModule = class MovieSearchPageModule {};
