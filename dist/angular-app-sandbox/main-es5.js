...
***************************************************************************** */ /* global Reflect, Promise */ var _extendStatics = function extendStatics(
  ...
  !*** ./src/app/core/constants/index.ts ***!
  \*****************************************/ /*! exports provided: BASE_SEARCH_URL, BASE_SEARCH_IMAGES_URL, BASE_YOUTUBE_VIDEOS_URL, POSTER_IMAGE_SIZE_PX, POSTER, ACTOR_IMAGE_SIZE_PX, ACTOR, DEFAULT_IMAGE_SIZE_PX, API_KEY, OVER_THE_ALLOWED_LIMIT, SERVER_DELAY_TIME, DIGITS, NO_ACTOR_IMAGE_URL, NO_SUCH_MOVIES, ERROR */ /***/ function srcAppCoreConstantsIndexTs(
            module,
            __webpack_exports__,
            __webpack_require__
        ) {
  ...
  !*** ./src/app/core/services/index.ts ***!
  \****************************************/ /*! exports provided: SearchFilmsService */ /***/ function srcAppCoreServicesIndexTs(
            module,
            __webpack_exports__,
            __webpack_require__
        ) {
            ...
            /* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "SearchFilmsService", function() {
                return _search_films_service_search_films_service__WEBPACK_IMPORTED_MODULE_1__["SearchFilmsService"];
            }); /***/
        },
  ...
  \****************************************************************************/ /*! exports provided: SearchFilmsService */ /***/ function srcAppCoreServicesSearchFilmsServiceSearchFilmsServiceTs(
            ...
            var SearchFilmsService = /*#__PURE__*/ (function() {
                function SearchFilmsService(http) {
                    /**
                 ...
                 */ var _proto = SearchFilmsService.prototype;
                _proto.getFilmsFromApi = function getFilmsFromApi(searchQuery) {
                    var _this = this;
                    ...
                    return this.behaviorSubject$.pipe(
                        ...
                        Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])(function(currPage) {
                            return _this.http.get(
                                Object(_utils_index__WEBPACK_IMPORTED_MODULE_5__["getSearchUrl"])(searchQuery, currPage)
                            );
                        }),
                 ...
                 */;
                _proto.getDebounceTime = function getDebounceTime() {
                 ...
                 */;
                _proto.getDetailsFilmsInfo = function getDetailsFilmsInfo(movies) {
                    var _this2 = this;
                    if (movies.length) {
                 ...
                 */;
                _proto.checkNoMovies = function checkNoMovies(movies) {
             ...
             */ var getImagesUrl = function getImagesUrl(searchValue, who) {
                switch (who) {
                    case "poster":
                        return (
                            "" +
                            _constants__WEBPACK_IMPORTED_MODULE_1__["BASE_SEARCH_IMAGES_URL"] +
  ...
  \**********************************************************/ /*! exports provided: getMovieDetailsUrl */ /***/ function srcAppCoreUtilsGetMovieDetailsUrlUtilTs(
             ...
             */ var getMovieDetailsUrl = function getMovieDetailsUrl(id) {
                return (
                    _constants__WEBPACK_IMPORTED_MODULE_1__["BASE_SEARCH_URL"] +
                    "movie/" +
                    id +
                    "?api_key=" +
  ...
  !*** ./src/app/core/utils/index.ts ***!
  \*************************************/ /*! exports provided: getSearchUrl, getImagesUrl, getMovieDetailsUrl, getMovieTrailerUrl */ /***/ function srcAppCoreUtilsIndexTs(
            module,
            __webpack_exports__,
            __webpack_require__
        ) {
  ...
  \********************************************************************************/ /*! exports provided: MovieListItemComponent */ /***/ function srcAppMovieSearchPageMovieListItemMovieListItemComponentTs(
            ...
            var MovieListItemComponent = function MovieListItemComponent() {};
  ...
  \**********************************************************************/ /*! exports provided: MovieListComponent */ /***/ function srcAppMovieSearchPageMovieListMovieListComponentTs(
            ...
            var MovieListComponent = /*#__PURE__*/ (function() {
                ...
                var _proto2 = MovieListComponent.prototype;
                _proto2.trackByFn = function trackByFn(_, film) {
                    return film.id;
                };
                return MovieListComponent;
            })();
  ...
  \******************************************************************/ /*! exports provided: MovieSearchPageComponent */ /***/ function srcAppMovieSearchPageMovieSearchPageComponentTs(
            ...
            var MovieSearchPageComponent = /*#__PURE__*/ (function() {
                function MovieSearchPageComponent(searchFilmsService) {
                    /**
                     * Loading flag.
                 ...
                 */ var _proto3 = MovieSearchPageComponent.prototype;
                _proto3.loadFilms = function loadFilms(searchQuery) {
                    var _this3 = this;
                    this.isSearchedFilms = false;
                    this.isNoMoreResults = false;
                 ...
                 */;
                _proto3.LoadMoreMovies = function LoadMoreMovies() {
                    this.isLoading = true;
            ...
            MovieSearchPageComponent.ctorParameters = function() {
                return [{ type: _core_services__WEBPACK_IMPORTED_MODULE_2__["SearchFilmsService"] }];
            };
                ...
                [
                    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
                        declarations: [
                            ...
                            _search_input_search_input_component__WEBPACK_IMPORTED_MODULE_9__["SearchInputComponent"],
  ...
  \**************************************************************************/ /*! exports provided: SearchInputComponent */ /***/ function srcAppMovieSearchPageSearchInputSearchInputComponentTs(
            ...
            var SearchInputComponent = /*#__PURE__*/ (function() {
                 ...
                 */ var _proto4 = SearchInputComponent.prototype;
                _proto4.onChangeInput = function onChangeInput() {
